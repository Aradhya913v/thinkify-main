...
import { getUserData, login, registration, dummyLogin, changePassword, getUsers, removeUser, getUserActivity } from '../controller/user.js';
...
user.post("/dummy-login", dummyLogin);
